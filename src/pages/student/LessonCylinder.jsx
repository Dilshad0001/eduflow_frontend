...
const LessonCylinder = ({chapterId,chapterName}) => {
    ...
    return (
        <div className="bg-white  rounded-full p-6 shadow-sm relative overflow-hidden border-none ">
            <h2 className="text-2xl font-bold text-gray-800 mb-6 text-center">lessons of {chapterName}</h2>

...
function TeacherLessonDetail() {
  ...
  useEffect(() => {
    const fetchLesson = async () => {
      try {
        const response = await axios.get(`http://localhost:8000/teacher/task/lesson/${lessonId}/`, {
          headers: {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50 to-teal-100 -mt-20">
      {/* Navigation Header */}


      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 ">
              <div className="sticky top-0  bg-white/90 backdrop-blur-xl border-b border-slate-200 ">

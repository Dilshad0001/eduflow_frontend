...
function LessonDetail() {
  ...
  useEffect(() => {
    const fetchLesson = async () => {
      try {
        const response = await axiosInstance.get(`adminuser/study/lesson/${id}/`, {
          // headers: {
  ...
  return (
    <div className="min-h-screen ">
      {/* Navigation Header */}
      <div className="sticky top-0 z-1 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-b border-white/20 dark:border-slate-700/50">
            ...
            <div className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-xl rounded-2xl p-6 shadow-2xl border border-white/20 dark:border-slate-700/50">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between py-2 border-b border-slate-200/50 dark:border-slate-700/50">
                  ...
                  <span className="text-sm font-medium text-slate-800 dark:text-slate-200">{id}</span>
                </div>
                <div className="flex items-center justify-between py-2 border-b border-slate-200/50 dark:border-slate-700/50">
